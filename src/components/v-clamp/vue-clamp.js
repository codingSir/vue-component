...
export default {
    ...
    methods: {
        hightLight(str){
            if  ( this.hightLightText &&  this.hightLightText.length > 0) {
                // 匹配关键字正则
                let  replaceReg =  new  RegExp( this.hightLightText,  'g' );
                // 高亮替换v-html值
                let  replaceString =  '<span style="color: rgb(245, 108, 108)">'  +  this.hightLightText +  '</span>' ;
                // 开始替换
